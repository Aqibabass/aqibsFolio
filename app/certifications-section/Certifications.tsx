  ...
  return (
    <section className="z-10 flex w-full flex-col items-center justify-center overflow-hidden bg-[#0E1016] bg-cover bg-center pt-20 md:pb-16 lg:pb-24">
      <div className="relative mb-16 flex w-full flex-col items-center justify-center gap-10 text-[#e4ded7] sm:items-center lg:max-w-[1440px]">
        ...
        />
        <AnimatedBody 
          text="Professional achievements and hands-on experience in software development and machine learning" 
          className="w-[90%] text-center text-[14px] font-semibold uppercase sm:w-[500px] md:w-[550px] md:text-[16px]" 
        />
        <motion.div className="grid w-[90%] max-w-[1345px] grid-cols-1 place-content-center place-items-center gap-6 sm:gap-6 md:gap-6 lg:gap-6 sm:grid-cols-2 lg:grid-cols-2">
